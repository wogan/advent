...
class Day07Example extends DayExample {
  /* --- Day 7: Bridge Repair ---
  ...
  finish the calibrations if only someone could determine which test values could possibly be produced by
  ...
  Day07.example(
    ...
    equations cannot be rearranged. Glancing into the jungle, you can see elephants holding two different types
