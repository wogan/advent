...
class Day01Example extends DayExample {
  ...
  Day01.example(
    ...
    measure how far apart they are. Pair up the smallest number in the left list with the smallest number
    in the right list, then the second-smallest left number with the second-smallest right number, and so on.
