...
class Day05Example extends DayExample {
  ...
  of carefully-planned steps. After the crates are rearranged, the desired crates will be
  ...
  rearrangement procedure, one crate is moved from stack 2 to stack 1, resulting in this configuration:
